...
Databricks Unity Catalog. The implementation uses Unity Catalog row filter functions adapted for ACL-table joining, on the same platform as the group-based exercise.
