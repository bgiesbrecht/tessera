...
- **Twenty-five GitHub issues** total. Resolved/closed: #1, #2, #6, #10 (closed by ADR-025). Open from worked-example findings: #3 (deferred-not-needed-yet), #4, #5, #7, #8, #9, #11, #12, #13, #14, #15. Open from the 2026-05-19 governance-gap survey: #16–#25 (see `docs/handoffs/2026-05-19-governance-gaps-handoff.md`); ten issues spanning coverage-confirmed (#16/#17/#18/#22), in-scope gaps (#19/#21/#25 — all scoping-needed), out-of-scope confirmation (#20), underexercised (#23), and integration-question (#24). Phase 2 scoping documents for #19/#21/#25 are queued; no spec changes from the gap survey landed in this cycle.
